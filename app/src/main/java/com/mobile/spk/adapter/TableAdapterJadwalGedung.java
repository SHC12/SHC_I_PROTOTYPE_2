...
public class TableAdapterJadwalGedung extends RecyclerView.Adapter {

    private Context context;
    private List<Jadwal> listData;
    private RecyclerViewClickListener mListener;

    public TableAdapterJadwalGedung(Context context, List<Jadwal> listData, RecyclerViewClickListener mListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.jadwal_gedung_items, parent, false);
    ...
    public class RowViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        TextView txtNama;
        TextView txtKode;
        RelativeLayout rvItemsJadwalGedung;
        TableAdapterJadwalGedung.RecyclerViewClickListener mListener;
        ...
        RowViewHolder(View itemView,  RecyclerViewClickListener listener) {
            ...
            rvItemsJadwalGedung = itemView.findViewById(R.id.rv_item_jadwal_gedung);
            mListener = listener;
            rvItemsJadwalGedung.setOnClickListener(this);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.rv_item_jadwal_gedung:
                    mListener.onRowClick(rvItemsJadwalGedung, getAdapterPosition());
                    break;
