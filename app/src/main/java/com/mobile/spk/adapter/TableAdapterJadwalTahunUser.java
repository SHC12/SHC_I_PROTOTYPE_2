...
public class TableAdapterJadwalTahunUser extends RecyclerView.Adapter {

    private Context context;
    private List<JadwalTahunUser> listData;
    private RecyclerViewClickListener mListener;

    public TableAdapterJadwalTahunUser(Context context, List<JadwalTahunUser> listData, RecyclerViewClickListener mListener) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.
                ...
                inflate(R.layout.riwayat_jadwal_tahun_user_items, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            JadwalTahunUser modal = listData.get(rowPos - 1);
    ...
    public class RowViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        TableAdapterJadwalTahunUser.RecyclerViewClickListener mListener;
        ...
        RowViewHolder(View itemView,  RecyclerViewClickListener listener) {
            ...
            rvItemsJadwalPersonal = itemView.findViewById(R.id.rv_item_jadwal_user);
            mListener = listener;
