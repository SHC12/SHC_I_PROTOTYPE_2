...
public class TableAdapterRiwayatPatroli extends RecyclerView.Adapter {

    private Context context;
    private List<RiwayatPatroliModel> listData;
    private RecyclerViewClickListener mListener;

    public TableAdapterRiwayatPatroli(Context context, List<RiwayatPatroliModel> listData, RecyclerViewClickListener mListener) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (rowPos == 0) {
            ...
            RiwayatPatroliModel modal = listData.get(rowPos - 1);
    ...
    public class RowViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        TableAdapterRiwayatPatroli.RecyclerViewClickListener mListener;
